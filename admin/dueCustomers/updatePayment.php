            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" style=" color: #aaaaaa;" href="./">Pending Payment</a>
                        </li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <label for="name">Total Amount
                                    <input type="text" name="Tamount" value="<?php echo $totalamount; ?>" readonly></label>
                            </div>
                            <div class="col">
                                <label for="name"> Paid Amount
                                    <input type="text" name="Pamount" value="<?php echo $paidamount; ?>" readonly></label>
                                <label for="name"> Due Amount
                                    <input type="text" name="Damount" value="<?php echo $dueamount; ?>" readonly></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="name"> Amount Customer Paid
                                    <input type="text" name="updateAmount" placeholder="Enter Amount Customer Paid"></label>
                            </div>
                        </div>
