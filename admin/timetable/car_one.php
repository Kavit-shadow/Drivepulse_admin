                        ...
                        <tr id="<?php echo $row['id']; ?>">
                            ...
                            <td class="btns">
                                <?php if ($row['status'] == 'active') {
                                    echo "<a id='btn' href='addDay.php?id=" . $row['id'] . "&car=" . $_GET['car'] . "&route=../timetable?car=i10#" . $row['id'] . "' style='background:green; '>+1 DAY</a>";
                                } ?>

                                <?php if ($row['status'] == 'active') {
                                    echo "<a id='btn' href='subDay.php?id=" . $row['id'] . "&car=" . $_GET['car'] . "&route=../timetable?car=i10#" . $row['id'] . "'  style='background:red; '>-1 DAY</a>";
                                } ?>
