                            ...
                            foreach ($logEntries as $entry) {
                                ...
                                if (is_array($entry['activity'])) {
                                    ...
                                    if (is_array($entry['activity']['0'])) {
                                        ...
                                        echo '<tbody>';
                                        echo '<tr>';
                                        echo "<td>" . "<br><b>Name</b>: " . $entry['activity']['0']['customer_details']['name'] . "<br><b>Phone</b>: " . $entry['activity']['0']['customer_details']['phone'] . "<br><b>Vehicle</b>: " . $entry['activity']['0']['customer_details']['vehicle'] . "<br<b>TimeSlot</b>: 
