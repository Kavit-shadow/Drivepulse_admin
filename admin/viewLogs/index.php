...
/* Hover effect on select options */
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <div>
                <iframe src="" id="logsiframe" style="width: 100%;height: 1200px;margin-top: 35px;border: none;border-radius: 10px;" title="Logs" allowfullscreen loading="lazy"></iframe>
            </div>
