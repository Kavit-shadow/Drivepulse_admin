            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT u.id, u.name, u.username, u.password, u.permissions, u.time, u.emp_uid, e.name as emp_name 
                                   FROM users_db u 
                                   LEFT JOIN employees e ON u.emp_uid = e.emp_uid";
                            $result = $conn->query($sql);
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td data-cell='Name'>" . $row["name"] . "</td>";
                                    echo "<td data-cell='Username'>" . $row["username"] . "</td>";
                                    echo "<td data-cell='Permissions'>" . $row["permissions"] . "</td>";
                                    echo "<td data-cell='Employee'>" . ($row["emp_name"] ? $row["emp_name"] : "Not Linked") . "</td>";
                                    echo "<td data-cell='Created at'>" . $row["time"] . "</td>";
                                    echo "<td data-cell='Action'>";
                                    echo "<a class='edit' href='quickEdit.php?i=" . $row["id"] . "&n=" . $row["name"] . "&u=" . $row["username"] . "&p=" . $row["permissions"] . "'>Quick Edit</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
