...
<head>
    ...
    <meta name="description" content="Patel Motor Driving School - Attendance System for tracking customer attendance">
    <meta name="keywords" content="driving school, motor training, attendance, Ahmedabad, Gujarat">
    <meta name="author" content="Patel Motor Driving School">
    <meta property="og:title" content="Attendance System - Patel Motor Driving School">
    <meta property="og:description" content="Customer attendance tracking system for Patel Motor Driving School">
    <meta property="og:image" content="https://i.postimg.cc/hjWfjxGX/PMDS-text-W.png">
    <meta property="og:url" content="https://maps.app.goo.gl/FYHLtcAZLfDRFLr66">
    <link rel="shortcut icon" type="image/png" href="../../assets/logo.png" />
    <link rel="apple-touch-icon" href="https://i.postimg.cc/hjWfjxGX/PMDS-text-W.png">
    <title>Attendance System | Patel Motor Driving School</title>
    <style>
        /* Modal styling */
        dialog {
            padding: 0;
...
<body>
    <header>
        <img src="https://i.postimg.cc/PqDyKvCH/PMDS-text-W.png" alt="Company Logo" class="logo">
    ...
    <footer>
        <p>&copy; 2024 Patel Motor Driving School. All rights reserved.</p>
        <div class="footer">
            ...
            <div class="social-media">
                <a href="https://maps.app.goo.gl/VU13ZPf6ukhgV1w19" target="_blank">
                    <img src="https://i.postimg.cc/LXFLNyP4/61488124d329bb0004dbd345.png" alt="Google Maps">
                </a>
                ...
                <a href="https://www.instagram.com/patelmotordrivingschool" target="_blank">
                    <img src="https://i.postimg.cc/Dw2mbqvn/pngwing-com-2.png" alt="Instagram">
                </a>
            </div>
        </div>
    </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const emp_uid = urlParams.get('id') || window.location.pathname.split('/').pop();
            ...
            if (localStorage.getItem('rememberedPin')) {
                const savedPin = localStorage.getItem('rememberedPin').split('');
                inputs.forEach((input, index) => {
                    input.value = savedPin[index] || '';
                });
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadAttendanceData() {
                const urlParams = new URLSearchParams(window.location.search);
                const id = localStorage.getItem('rememberedPin');
                                ...
                                if (allDates.length > 0) {
                                    ...
                                    if (attendanceData && attendanceData.date === currentDate) {
                                        ...
                                        tr.innerHTML = `
                                            ...
                                            <td style="padding: 12px; border: 1px solid #ddd;">${escapeHtml(attendanceData.date || '')}</td>
                                        ...
                                        tr.innerHTML = `
                                            ...
                                            <td style="padding: 12px; border: 1px solid #ddd;">-</td>
                                            <td style="padding: 12px; border: 1px solid #ddd; background-color: #ffe6e6;">${currentDate} (Absent)</td>
                                            <td style="padding: 12px; border: 1px solid #ddd;">-</td>
                                            <td style="padding: 12px; border: 1px solid #ddd;">-</td>
                                            <td style="padding: 12px; border: 1px solid #ddd;">-</td>
                                            <td style="padding: 12px; border: 1px solid #ddd;">-</td>
