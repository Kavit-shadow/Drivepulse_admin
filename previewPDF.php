...
<body>
  <div class="vert">
    <div class="vertical-text">
      <p style="color: #f5f5f5; filter: drop-shadow(0 0 10px);"><br><span style="color: red">PDF</span> Preview <span style="color: red">PDF</span> Preview <span style="color: red">PDF</span></p>
    </div>
  </div>
  <div class="load">
...
"><?php echo $cust_uid; ?>
  ...
  <script>
    function redirect() {
      window.location = "./pdf_gen.php?id=<?php echo $id; ?>&email=<?php echo $email; ?>&name=<?php echo $name; ?>&VN=<?php echo $VN; ?>&timeslot=<?php echo $timeslot; ?>&who=<?php echo $_GET['who']; ?>";
    }
    var delay = 500;
