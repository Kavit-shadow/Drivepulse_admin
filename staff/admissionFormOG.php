    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (!isset($error)) {
            ...
            if (isset($result)) {
                ...
                logActivity('staff_logs', $_SESSION['staff_name'], array("What" => "Booked Admission", array("customer_details" => array("name" => $name, "phone" => $phone, "vehicle" => $vehicleDetails, "timeSlot" => $timeSlot, "addmission_date" => $currentDate, "days" => $days, "started_at" => $startedAT, "ended_at" => $Ends_On, "formfiller" => $_SESSION['staff_name']))));
                    ...
                    width: 285px;">
                        ...
                        <div id="bikeFields" style="display: none;">
                            <div class="input-field">
                                ...
                                <input type="text" name="bikeTime" id="bikeTime" placeholder="Enter Enter Duration">
                            </div>
                        </div>
