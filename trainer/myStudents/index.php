        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="./">My Students</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody id="studentTableBody">
                                ...
                                $query = "SELECT id, name, phone, vehicle, timeslot, startedAT, endedAT, date 
                                         FROM cust_details 
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        if ($current_date != $row['date']) {
                                            echo "<tr><td colspan='7' style='background-color: #f8f9fa; font-weight: bold; text-align: center;'>" .
                                        ...
                                        echo "<td>" . htmlspecialchars($row['startedAT']) . "</td>";
                                        echo "<td>" . htmlspecialchars($row['endedAT']) . "</td>";
                                        echo "<td><button class='view-btn' onclick='window.location.href = \"../view?id=" . urlencode($row['id']) . "&phone=" . urlencode($row['phone']) . "&route=../myStudents\"'><i class='bx bx-show'></i> View</button></td>";
                                        echo "</tr>";
                                    }
                                } else {
            ...
            <script>
                ...
                document.getElementById('searchInput').addEventListener('keyup', function() {
                    ...
                    let tableRows = document.getElementById('studentTableBody').getElementsByTagName('tr');
